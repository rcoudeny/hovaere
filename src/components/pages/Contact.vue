  ...
  <div id="contact">
    ...
    <form @submit.prevent="onSubmit(name, email, phone, question)">
      <div class="formpair">
        ...
        <input id="name" type="text" v-model="name" placeholder="Voornaam Fanilienaam" />
      </div>
      <div class="formpair">
        <label for="email">Email adres</label>
        <input id="email" type="text" v-model="email" placeholder="voorbeeld@gmail.com" />
      </div>
      <div class="formpair">
        <label for="phone">Telefoonnummer <span>(optioneel)</span></label>
        <input id="phone" type="text" v-model="phone" placeholder="+32 56 61 54 94" />
      </div>
      <div class="formpair">
